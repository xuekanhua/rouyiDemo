<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="clubList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="社团简介" align="center" prop="introduce" />
      <el-table-column label="创建人" align="center" prop="createUser" />
      <el-table-column label="社团类别" align="center" prop="type" />
      <el-table-column label="社团状态" align="center" prop="status" />
      <el-table-column label="是否删除" align="center" prop="deleted" />
      <el-table-column label="社团标志" align="center" prop="img" width="100">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="社团简介" prop="introduce">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          { required: true, message: "社团状态不能为空", trigger: "blur" }
        ],
        deleted: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除社团管理编号为"' + ids + '"的数据项？').then(function() {
        return delClub(ids);
      }).then(() => {
        this.getList();
